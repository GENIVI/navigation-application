...
quitText[WIDTH]=98;
quitText[HEIGHT]=46;
quitText[TEXTCOLOR]=Qt.rgba(0, 0, 0, 1);
quitText[STYLECOLOR]=Qt.rgba(0, 0, 0, 1);
...
var fsa_main_menu_background=new Object;
fsa_main_menu_background[SOURCE]="Core/images/fsa-main-menu-background.png";
fsa_main_menu_background[X]=0;
fsa_main_menu_background[Y]=0;
fsa_main_menu_background[WIDTH]=800;
fsa_main_menu_background[HEIGHT]=454;
